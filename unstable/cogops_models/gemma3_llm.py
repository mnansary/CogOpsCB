...
if __name__ == '__main__':
    ...
    if all([small_api_key, small_model, small_base_url]):
        small_llm_service = LLMService(small_api_key, small_model, small_base_url, max_context_tokens=32768)
    else:
    ...
    if all([medium_api_key, medium_model, medium_base_url]):
        medium_llm_service = LLMService(medium_api_key, medium_model, medium_base_url, max_context_tokens=131072)
    else:
    ...
    if small_llm_service:
        ...
        try:
            ...
            response = small_llm_service.invoke(prompt, temperature=0.1, max_tokens=256)
            print(f"Response:\n{response}")
        except Exception as e:
    ...
    if small_llm_service:
        ...
        try:
            ...
            print(f"Prompt: {prompt}\nStreaming Response:")
            for chunk in small_llm_service.stream(prompt, temperature=0.2, max_tokens=256):
    ...
    if small_llm_service:
        ...
        try:
            ...
            print(f"Prompt: {prompt}")
            nid_data = small_llm_service.invoke_structured(prompt, NIDInfo, temperature=0.0)
    ...
    if medium_llm_service:
        ...
        try:
            ...
            print(f"Prompt: {prompt}")
            response = medium_llm_service.invoke(prompt, temperature=0.1, max_tokens=512)
            print(f"Response:\n{response}")
        except Exception as e:
            print(f"An error occurred: {e}")
    ...
    if medium_llm_service:
        ...
        try:
            ...
            print(f"Prompt: {prompt}\nStreaming Response:")
            for chunk in medium_llm_service.stream(prompt, temperature=0.1, max_tokens=512):
                print(chunk, end="", flush=True)
            print()
        except Exception as e:
            print(f"An error occurred: {e}")
    ...
    if medium_llm_service:
        ...
        try:
            ...
            print(f"Prompt: {prompt}")
            passport_data = medium_llm_service.invoke_structured(prompt, PassportInfo, temperature=0.0)
